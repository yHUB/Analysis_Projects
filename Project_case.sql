...
Select *, 
case when comments like '%disputed%' then 1 else 0 end as disputed,
case when comments like '%negogiate%' then  'Negogiatde order' 
 when comments like '%dispute%' then ' Disputed orfder' else ';No dispute' end as status_1
 from orders
